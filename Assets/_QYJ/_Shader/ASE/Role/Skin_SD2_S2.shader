...
Shader "Skin_SD2_S2"
{
	...
	SubShader
	{
		...
		#pragma target 3.0
		#pragma shader_feature _SKIN_RAMPMAP _SKIN_SSS
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			#endif //aseld
			float dotResult65 = dot( ase_worldlightDir , ase_worldNormal );
			float temp_output_67_0 = ( ( dotResult65 * 0.5 ) + 0.5 );
			float2 appendResult68 = (float2(temp_output_67_0 , temp_output_67_0));
			float4 _RampVar70 = ( tex2D( _RampMap, appendResult68 ) * _RampIntensity );
			#if defined(_SKIN_RAMPMAP)
				float4 staticSwitch73 = ( _RampVar70 * temp_output_19_0 );
			#elif defined(_SKIN_SSS)
				float4 staticSwitch73 = ( temp_output_19_0 + _SSSVar52 );
			#else
				float4 staticSwitch73 = ( temp_output_19_0 + _SSSVar52 );
			#endif
			o.Emission = staticSwitch73.rgb;
			float2 uv_MaskMap = i.uv_texcoord * _MaskMap_ST.xy + _MaskMap_ST.zw;
			float4 tex2DNode13 = tex2D( _MaskMap, uv_MaskMap );
			o.Specular = ( _SpecularColor * tex2DNode13 ).rgb;
			o.Smoothness = ( tex2DNode13.a * _Smoothness );
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18935
-1823;307;1531;733;1545.747;435.3904;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;34;-2711.997,367.1429;Inherit;False;Property;_SSS;SSS;10;0;Create;True;0;0;0;False;0;False;1;0.99;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;9;-3306.266,-306.7763;Inherit;True;Property;_BaseMap;基础图;2;0;Create;False;0;0;0;False;0;False;-1;None;1e059704fd5f39841a9072a65e09382d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;8;-3216.266,-477.7766;Inherit;False;Property;_Color;颜色;0;0;Create;False;0;0;0;False;0;False;1,1,1,1;1,0.9921568,0.9843137,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.DynamicAppendNode;68;-3025.914,1082.091;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;44;-2273.53,190.8261;Inherit;False;Property;_SSSIntensity;SSS强度;11;0;Create;False;0;0;0;False;0;False;1;1;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;56;-919.9677,-115.7838;Inherit;False;55;_BaseVar;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-890.7322,-38.20653;Inherit;False;Property;_Brightness;补光;1;0;Create;False;0;0;0;False;0;False;0;0.4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;71;-791.1608,-201.7144;Inherit;False;70;_RampVar;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;53;-769.3976,35.46097;Inherit;False;52;_SSSVar;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;-739.9324,-81.00652;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;13;-1099.899,458.1064;Inherit;True;Property;_MaskMap;遮罩图（RGB高光A平滑度）;5;0;Create;False;0;0;0;False;0;False;-1;None;8606efd6a7fd764499c95f00b0ec1395;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-1078.199,648.3071;Inherit;False;Property;_Smoothness;平滑度;7;0;Create;False;0;0;0;False;0;False;0.5;0.4;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;51;-555.8906,-19.07408;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;11;-745.3373,129.0269;Inherit;True;Property;_BumpMap;法线图;3;0;Create;False;0;0;0;False;0;False;-1;None;af548b04ed68da04098955087a946e5a;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;57;-339.5526,-222.6587;Inherit;False;55;_BaseVar;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-753.8981,588.6071;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;61;2;73;0
WireConnection;61;3;17;0
WireConnection;61;4;15;0
ASEEND*/
//CHKSM=80E625E2E1AAFC44FC67B1EF7931E8D95F851D19